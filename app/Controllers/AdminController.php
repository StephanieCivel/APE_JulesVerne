...
class AdminController extends MainController
{
    public function renderAdmin(): void
    {
        ...
        if (isset($this->subPage)) {
            ...
            $this->data['posts'] = EventModel::getPosts();
        }
    ...
    public function removePost(): void
    {
        ...
        if (EventModel::deletePost($postId)) {
